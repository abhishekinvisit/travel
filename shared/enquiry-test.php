...
<div class="popup_Box" id="enquirypopup"">
  <div class="center-block">
    <div class="outer">
      <div class="enquiryBox"> <a href="javascript:void(0)" class="close__popup"><img src="images/icon/popup-close.svg" alt="" /></a>
        <div class="left"> <img src="images/popup-banner.svg?12223" alt="" /> </div>
		<div class="popupmobile_image">
		<img src="images/popup-banner_mobile.jpg?1222" alt="" />
		</div>
        <div class="right">
          <h2>Let us Help!</h2>
...
<div class="popup_Box tenminPopup" id="enquirypopup_offer">
  <div class="center-block">
    <div class="outer">
      <div class="enquiryBox"> <a href="javascript:void(0)" id="closePopupBtn" class="close__popup "><img src="images/icon/popup-close.svg" alt="" /></a>
		...
		<div class="popupmobile_image">
		<img src="images/popup-banner_mobile.jpg?345" alt="" />
		</div>
        <div class="right">
...
<script>
        // Get references to elements
        const openPopupBtn = document.getElementById('openPopupBtn1');
        const popup = document.getElementById('enquirypopup_offer1');
        ...
        openPopupBtn.addEventListener('click', function() {
			...
			if (window.matchMedia('(max-width: 768px)').matches){
				...
				popup.style.cssText ='display: block; bottom: 0px;';
			}
			else {
			   //popup.style.display = 'block';
			   popup.style.cssText ='display: block; top: 0px; bottom: inherit;';
			}
        });
        ...
        closePopupBtn.addEventListener('click', function() {
			...
			if (window.matchMedia('(max-width: 768px)').matches){
				...
				popup.style.cssText ='display: block; bottom: -200%;';
			}
			else {
			   //popup.style.display = 'none';
			   popup.style.cssText ='display: none; top: 0px; bottom: inherit;';
			}
        });
