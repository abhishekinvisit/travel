...
<html>
<head>
<title>College Bali Tour Packages </title>
...
<link rel="canonical" href="https://invisit.in/bali-tour-packages/college-bali-tour-package.php">
...
<div id="wrapper"> 
  ...
  <div id="mainCntr"> 
    ...
    <div class="citybannerBox shadow" style="background-image:url(../images/destination/bali/bali-banner11.jpg);">
      <div class="banner_text">
        <div class="container">
          <h1>College Bali Tour Packages <span>3n/4d</span></h1>
      ...
      <div class="container"> 
        ...
        <div id="leftCntr"> 
          ...
          <div class="overviewBox">
            ...
            <div class="blockBox">
<p><strong>College Bali Tour Package - 3 Night 4 Day</strong></p>

<p>Take a break from the busy college schedule and explore the land of scenic beauty with our college Bali tour packages, which are specially designed for the college students to have fun and relaxation during the trip. Book college Bali tour package and enjoy a thrilling trip to Bali with your college friends.</p>

<p><strong>About College Bali tour Package</strong> </p>

<ul>
  <li>Witness the natural scenic beauty of Bali </li>
  <li>Enjoy various water activities with your college buddies</li>
  <li>Take a tour to the Kintamani Volcano</li>
  <li>Pay a visit to Lake Batur from Mount Batur</li>
  <li>Enjoy exotic Balinese cuisine </li>
</ul>
            </div>
          </div>
          <!--  \ overview box / --> 
  ...
  <li>College Bali tour packages begin with your arrival at Bali airport</li>
  <li>Then move towards the pre-book hotel</li>
  <li>Check-in and relax your tired soul</li>
  <li>Enjoy the resort/hotel ambiance with your friends</li>
  ...
  <li>Overnight stay at the hotel</li>
              ...
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Post breakfast, set off for Barong Kintamani tour </li>
  <li>Click stunning pictures of breathtaking views of Lake Batur from Mount Batur. </li>
  <li>Take a break at Singapadu Village on the route to watch live Keris dance performances. </li>
  <li>Later, make your way to the Kintamani Volcano. </li>
  <li>Trek up to Mount Batur for mesmerizing views of Lake Batur and Volcano</li>
  <li>The move towards Penelokan for amazing views of the Batur lakes</li>
  <li>End your day with a tour of the famous Monkey Forest</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Begin sightseeing tour, after having breakfast</li>
  <li>Visit the top tourist attractions in Kuta</li>
  <li>In the evening you can visit the local markets and shop for souvenirs </li>
  <li>Enjoy the delicious dinner.</li>
  <li>Overnight stay at the hotel</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 4</span> | Departure | College Bali Trip Ends</h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Check out of the hotel</li>
  <li>The driver will drop you off at the airport.</li>
  <li>College Bali tour packages ends here with lifelong memories. </li>
                    </ul>
                  </div>
                </div>
              </div>
  ...
  <li>Travelers must take care of their bags and valuables. The management will not be held liable for any lost things during the tour.</li>
        ...
        <div id="rightCntr">
          ...
          <div class="rightblock sticky" >
            ...
            <div class="sendequiry rightBlcok"> <strong>₹ 22999</strong> <small>Per Person</small>
              <p>Starting from <span class="discount">₹ 26999</span> <br>
                <b>30% OFF</b></p>
