...
<html>
<head>
<title>Island Escape: Bali tour package </title>
<meta http-equiv="content-type" content="text/html;charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<meta name="description" content="Book 5 night 6 day Bali tour package to enjoy a thrilling vacation around the clear beaches and tropical region with your family and friends for an refreshing trip.">
<meta name="keywords" content="Bali tour package, Bali trip">
<meta name="author" content="invisit">
<meta name="robots" content="index, follow">
<link rel="icon" type="image/x-icon" href="../images/favicon.ico">
<link rel="canonical" href="https://invisit.in/bali-tour-packages/5-nights-6-days-bali-tour-package.php">
...
<div id="wrapper"> 
  ...
  <div id="mainCntr"> 
	...
	<div class="citybannerBox shadow" style="background-image:url(../images/destination/bali/bali-banner-4.jpg);">
      <div class="banner_text">
        <div class="container">
          <h1>Island Escape: Bali Tour Package <span>5n/6d</span></h1>
        ...
        <div id="leftCntr"> 
          ...
          <div class="overviewBox">
            ...
            <div class="blockBox">
				...
				<p><strong>Island Escape: Bali Tour Package With Uluwatu Sunset Tour</strong></p>

<p>Bali, known as the &quot;Island of the Gods,&quot; attracts visitors from all over the globe with its scenic beaches, tranquil shoreline, temples, green rice fields, attractive waterfalls, and so much more. Bali is loved by all and is one of the most popular tourist destinations. On this incredible 5-night 6 day Bali tour package, you can spend time with your loved ones while discovering this tropical paradise.</p>


<p><strong>About the Bali Tour package</strong></p>

<ul>
  <li>Admire the breathtaking views of Mt. Batur and Lake Batur</li>
  <li>Click mesmeric photos while sitting in the famous Bali Swing</li>
  <li>Enjoy green Tegalallang rice fields</li>
  <li>Experience all thrilling adventure sports</li>
</ul>
  ...
  <li>Begin the thrilling and relaxing Bali Tour</li>
  <li>On your arrival, meet our executive at the Airport</li>
  <li>Then the driver will drop you off at the hotel/villa</li>
  <li>Rest of the day at Leisure</li>
              ...
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>2nd day begins with looking at the early sunshine and coffee</li>
  <li>After breakfast, begin a sightseeing journey by visiting Lake Batur & Matur Batur</li>
  <li>It's time to visit Coffee Plantation, which is known for different types of coffee</li>
  <li>Enjoy the Bali swing that offers you a stunning green meadow view</li>
  <li>Later visit the Heaven Gate, a great spot for photographers.</li>
                    </ul>
              ...
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Wake up and freshen up as the day has stored a lot of popular sightseeing</li>
  <li>Visit the popular landmark in Bali, The Handara Gate</li>
  <li>Then take a tour of Ulun Danu Temple, which is world-renowned for its scenic beauty.</li>
  <li>This temple is also known as a floating Temple.</li>
  <li>You can take a boat ride at Ulun Danu.</li>
  <li>In the evening visit Tanah Lot, where you can enjoy the mesmeric Sunset</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
 <li>Wake up and get ready for the 4th day</li>
  <li>Following breakfast, you will transfer to the harbor to join a shared boat to Nusa Penida Island.</li>
  <li>In Nusa Penida,  the driver will take you on a full-day trip that includes visits to Kelingking Beach, Angel Bilabong, Broken Bay, and Bubu Beach.</li>
  <li>Overnight stay at the hotel</li>
              ...
              <div class="accordianRow">
                ...
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>The day stores a lot of fun activities for you</li>
  <li>Take part in various water sports like Banana boat ride, parasailing, and Jet skiing at your own expense</li>
  ...
  <li>Travelers must take care of their bags and valuables. The management will not be held liable for any lost things during the tour.</li>
        ...
        <div id="rightCntr">
          ...
          <div class="rightblock sticky" >
            ...
            <div class="sendequiry rightBlcok"> <strong>₹41250 </strong> <small>Per Person</small>
              <p>Starting from <span class="discount">₹44250 </span> <br> <b>30% OFF</b></p>
