...
<html>
<head>
<title>Corporate Bali Tour Packages </title>
<meta http-equiv="content-type" content="text/html;charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<meta name="description" content="Book corporate Bali tour package with invisit and excape to a serene destination from the daily hustle of life. Book ow and get exciting deals on Bali packages.">
<meta name="keywords" content="Corporate Bali Tour Packages, corporate trip, bali packages, bali trip packages">
<meta name="author" content="invisit">
<meta name="robots" content="index, follow">
<link rel="icon" type="image/x-icon" href="../images/favicon.ico">
<link rel="canonical" href="https://invisit.in/bali-tour-packages/corporate-bali-tour-package.php">
...
<div id="wrapper"> 
  ...
  <div id="mainCntr"> 
    ...
    <div class="citybannerBox shadow" style="background-image:url(../images/destination/bali/bali-banner13.jpg);">
      <div class="banner_text">
        <div class="container">
          <h1>Corporate Bali Tour Packages <span>3n/4d</span></h1>
      ...
      <div class="container"> 
        ...
        <div id="leftCntr"> 
          ...
          <div class="overviewBox">
            ...
            <div class="blockBox">
              <p><strong>Corporate Bali Tour Package - 3 Night 4 Day</strong></p>
              <p>Enjoy relaxing and thrilling corporate Bali tour packages to escape from your daily schedule and enjoy a vacation with your office buddies at the green rice terrace and scenic natural ambiance. Explore the diverse natural richness and turquoise oceans with office buddies and make memories of a lifetime. Book corporate Bali tour packages with invisit.</p>
              <p><strong>About Corporate Bali tour Package</strong> </p>
              <ul>
                <li>Sense fresh mountain air and lovely ambiance </li>
                <li>Pay a visit to Kintamani Volcano</li>
                <li>Witness the sun beaming over Lake Batur from Mount Batur.</li>
                <li>Enjoy the exotic tropical food.</li>
              </ul>
            </div>
          </div>
          <!--  \ overview box / --> 
          ...
          <div class="accordianBox">
            ...
            <div class="blockBox">
              <div class="accordianRow">
                <h3 class="accordion active"><span>Day 1</span> | Arrival | Corporate Bali Trip Begins </h3>
                <div class="expendaccordian" style="max-height:initial;">
                  <div class="content">
                    <ul class="contentList">
                      <li>The Bali tour package begins on your arrival at Bali</li>
                      <li>After arriving, head to the spectacular Nusa Dua resort. Check into your hotel.</li>
                      <li>Stroll around the resort's gorgeous surroundings or simply relax in your accommodation.</li>
              ...
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 2</span> | Nusa Dua | Kintamani Tour</h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
                      <li>Post breakfast, depart for Barong Kintamani with the office buddies</li>
                      <li>Pay a visit to mesmeric Lake Batur from Mount Batur.</li>
                      <li>Explore Singapadu Village and live stream the traditional Barong and Keris dance performances. </li>
                      <li>Then pay a visit to Kintamani Volcano. </li>
                      <li>Trek to Mount Batur for magical views of Lake Batur and Agung Volcano in the background. </li>
              ...
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 3</span> | Kuta Sightseeing Day</h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
                      <li>Post breakfast, begin the sightseeing journey </li>
                      <li>Begin with Kuta and Seminyak </li>
                      <li>Click on your office group picture with this stunning background</li>
                      <li>You can go shopping in Bali for local handicrafts and souvenirs. </li>
                      <li>Enjoy the dinner while enjoying the beautiful surroundings.</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 4</span> | Departure | Corporate Bali Trip Ends</h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
                      <li>Check out and get transferred to Airport</li>
                      <li>Here, amazing corporate Bali tour packages ends</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div id="rightCntr">
          ...
          <div class="rightblock sticky" >
            ...
            <div class="sendequiry rightBlcok"> <strong>₹ 28999</strong> <small>Per Person</small>
              <p>Starting from <span class="discount">₹ 32999</span> <br>
                <b>30% OFF</b></p>
