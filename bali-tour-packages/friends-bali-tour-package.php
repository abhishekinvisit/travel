...
<html>
<head>
<title>Friends Bali Tour Packages </title>
  ...
  <div id="mainCntr"> 
    ...
    <div class="citybannerBox shadow" style="background-image:url(../images/destination/bali/bali-banner10.jpg);">
      <div class="banner_text">
        <div class="container">
          <h1>Friends Bali Tour Packages <span>3n/4d</span></h1>
      ...
      <div class="container"> 
        ...
        <div id="leftCntr"> 
          ...
          <div class="overviewBox">
            ...
            <div class="blockBox">
<p><strong>Friends Bali Tour Package - 3 Night 4 Day</strong></p>

<p>Planning a friend's trip, but not sure about the destination! Here, we designed the ultimate Bali tour packages for friends that offer a thrilling yet relaxing vacation experience throughout the trip. The beautiful rice fields, gorgeous temple places and beaches are worth the hype. You can enjoy and experience the island adventure with your buddies only with Friends Bali tour packages. Book Now!</p>


<p><strong>About Friends Bali tour Package</strong></p>

<ul>
  <li>Immerse yourself in the mesmeric beauty of Bali</li>
  <li>Take a tour to the Tanha Lot</li>
  <li>Trek up and witness Mount Batur</li>
  <li>Enjoy various water sports with friends</li>
</ul>
            </div>
          </div>
          <!--  \ overview box / --> 
  ...
  <li>Get ready for the Friends Bali tour packages</li>
  <li>Trip begins on your arrival at the Airport</li>
  <li>Your group will receive greetings from our executive</li>
  <li>After quick interaction, you can head towards your resort/hotels</li>
  <li>Enjoy the resort's vicinity and relax in your hotel.</li>
  <li>Doze off early to begin amazing sightseeing tour</li>
                    </ul>
              ...
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 2</span> | Nusa Dua: Full day Barong Kintamani tour </h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>The first day on your friends Bali tour package is all about exploring Nusa Dua</li>
  <li>After breakfast, begin Barong Kintamani tour</li>
  <li>Take short trip to Singapadu Village on the route to Kintamani volcano</li>
  <li>Here, you can witness the popular Keris dance performances.</li>
  <li>Treat your eyes to lovely green plantation stretches of Madu Pertiwi's coffee</li>
  <li>Then you can make your way to the Kintamani Volcano.</li>
  <li>Walk to the Mount Batur for an amazing scenic view of Lake Batur</li>
  <li>After lunch, you can visit Batur lakes, surrounding mountains, hot springs, sunset, and rice terraces.</li>
  <li>Overnight stay at the hotel</li>
              ...
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 3</span> | Kuta: Sightseeing </h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Your friends will love the third day, as its about exploring Kuta</li>
  <li>After breakfast, you can begin the sightseeing journey</li>
  <li>Enjoy the delicious Balinese meal in Lunch</li>
  <li>Resume the sightseeing tour to Seminyak</li>
  <li>Enjoy various water sports with your friends at Kuta Beach</li>
  <li>In the evening, go shopping at the local market.</li>
  <li>You can shop for local handicrafts and souvenirs.</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="accordianRow">
                <h3 class="accordion"><span>Day 4</span> | Nusa Dua: Departure </h3>
                <div class="expendaccordian">
                  <div class="content">
                    <ul class="contentList">
  <li>Wake up and check out of the hotel</li>
  <li>The driver will transfer you to the airport.</li>
  <li>Here an amazing friends bali tour packages ends.</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div id="rightCntr">
          ...
          <div class="rightblock sticky" >
            ...
            <div class="sendequiry rightBlcok"> <strong>₹ 25999</strong> <small>Per Person</small>
              <p>Starting from <span class="discount">₹ 29999</span> <br>
                <b>30% OFF</b></p>
